#ifndef ICHEMIATEST_HPP_15
#define ICHEMIATEST_HPP_15
...
public:
    ...
    void TestIschemicHeart()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("IschemiaOnHeart_15");
	...
	AbstractTetrahedralMesh<3,3>* p_mesh = &(bidomain_problem.rGetMesh());
        VtkMeshWriter<3,3> vtk_writer("./ISHEMIA_15/", "init_mesh_1", false);
        vtk_writer.WriteFilesUsingMesh(*p_mesh);

        VtkMeshWriter<3,3> vtk_writer2("./ISHEMIA_15/", "init_mesh_2", false);
