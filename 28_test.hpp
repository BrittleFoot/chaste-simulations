#ifndef ICHEMIATEST_HPP_28
#define ICHEMIATEST_HPP_28
...
public:
    ...
    void TestIschemicHeart()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("IschemiaOnHeart_28");
	...
	AbstractTetrahedralMesh<3,3>* p_mesh = &(bidomain_problem.rGetMesh());
        VtkMeshWriter<3,3> vtk_writer("./ISHEMIA_28/", "init_mesh_1", false);
        vtk_writer.WriteFilesUsingMesh(*p_mesh);

        VtkMeshWriter<3,3> vtk_writer2("./ISHEMIA_28/", "init_mesh_2", false);
